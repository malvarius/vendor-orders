...
Kara Trieglaff`
        ...
        finalObject[key].forEach(element=>{
            var lineItem= `${element.Alcohol} | Quantity: ${element.qtyNeeded} \n`
            list+= lineItem
        })
        ...
        <button data-id="${count}" class="btn btn-warning d-block mx-auto mb-5 grabText">Copy to Clipboard</button>
        `
